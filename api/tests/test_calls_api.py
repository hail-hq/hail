...
async def test_post_calls_happy_path_201(
    ...
    pn = await _add_phone_number(async_session, org.id, e164="+14155551234")
...
async def test_post_calls_livekit_failure_marks_call_failed(
    ...
    await _add_phone_number(async_session, org.id)
...
async def test_post_calls_uses_explicit_from_e164(
    ...
    chosen = await _add_phone_number(
        async_session,
        org.id,
        e164="+14155550002",
...
async def test_get_call_by_id_returns_404_for_other_org(
    ...
    await _add_phone_number(async_session, org_a.id)
