...
3. **[MCP clients](./mcp.md)** — connect Claude.ai / ChatGPT / Cursor / Claude Code to your Hail deployment. Independent of voice setup; needed only for agent-driven flows.
